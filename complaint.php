...
<body>
 <form id="form1" runat="server" method="post" action="phpmailingfolder/complaintmail.php">
		<header id="header">
        	...
        	<center><font color="cyan">Last edit: SEP 27, 3:51 AM</center></font>
                    <ul class="nav navbar-nav">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="complaint.php"><span class="glyphicon glyphicon-edit"></span> &nbsp Complaint</a></li>
	...
	<marquee behavior="scroll" direction="left" style="color:cyan;font-size:40;font-family:times new roman">Please Register your complaint here</marquee>
	...
	<div class = "complaintForm">
		...
		<form action="phpmailingfolder/complaintmail.php" method="post">
			<br>
			<h2><font color="black">Please Issue your complaint here. <br> We will get back to you soon</font></h2><br><br>
			<textarea type="text" name="subject" placeholder="Subject_of_complaint"></textarea> <br><br>
			<textarea type="text" name="complaint" placeholder="Detailed_Complaint"></textarea>
			<br><br>
